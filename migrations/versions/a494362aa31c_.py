...
Revision ID: a494362aa31c
Revises: 
Create Date: 2022-02-11 13:25:59.877129
...
def upgrade():
    ...
    with op.batch_alter_table('prices', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_prices_timestamp'), ['timestamp'], unique=False)
